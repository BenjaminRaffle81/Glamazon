...
var addInventory = function(){
	var addInvt = {
		properties:{
			inventoryID: {
				description: colors.green('What is the ID number of the sexy-a$$ product you want to add inventory for?')
			},
			inventoryAmount:{
				description: colors.green('How many fab items do you want to add to the inventory?')
			}
		},
	};
...
var newProduct = {
		properties: {
			...
			newItemName:{ description: colors.gray('Please enter the name of the product?')},
			newItemDepartment: { description: colors.gray('What department?')},
			newItemPrice: { description: colors.gray('Please enter the price of the item')},
